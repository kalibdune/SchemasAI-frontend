...
export default function Chat() {
    return (
        <div className="flex w-full flex-col items-center justify-center">
            <div>
                <div style={{ backgroundColor: "rgba(255,255,255,0.25)", border: "1px solid white", borderRadius: "50%", padding: "8px", cursor: "pointer" }} className="fixed top-1/32 right-1/32">
            ...
            <svg width="109" height="38" viewBox="0 0 109 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="fixed bottom-11/12">
            ...
            <SideBar />
            <div className="flex flex-col items-center text-center min-w-1/3 gap-12">
